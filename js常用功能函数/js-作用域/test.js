...
var a;
console.log(a); //输出函数a的定义，而非undefined，因为js会先变量提升，然后函数提升，所以函数定义会覆盖之前的变量，又或者是因为变量a是undefined所以被忽略于是输出function ？
...
console.log(a); // 2, js会先变量提升，然后函数提升，然后运行到相应地方赋值